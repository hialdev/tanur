...
class PurchaseOrderController extends Controller
{
    ...
    public function setting($id, Request $request){
        ...
        return view('purchase_orders.setting', compact('reqorders', 'transports', 'principals', 'pics', 'purchase', 'filter', 'products', 'warehouses'));
    }
    ...
    public function process($id, Request $request){
        try {
            ...
            if($purchase->status == 0){
                ...
                return redirect()->route('receive.add', ['poid' => $purchase->id, 'whid' => $purchase->warehouse->id])->with('success', 'Silahkan selesaikan dengan mengisi data penerimaan barang.');
            }else{
