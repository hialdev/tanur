...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Tambah Principal</h4>
    ...
    <div class="row">
        <div class="col-md-4 h-100 mb-3">
            ...
            <img src="" id="preview-image" alt="principal Image Preview" class="d-none rounded-4 shadow w-100"
                style="">
        </div>
        <div class="col-md-8">
            <div class="card">
                <div class="px-4 py-3 border-bottom">
                    <h5 class="card-title fw-semibold mb-0">Tambah Principal</h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="{{route('principal.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control ps-2" name="description" id="description" cols="20" rows="5"
                                    placeholder="Description about this principal">{{ old('description') }}</textarea>
                            </div>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                            ...
                            <div class="">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control bg-white ps-2" name="address" id="address" cols="20" rows="5"
                                        placeholder="Alamat utama Principal">{{ old('address') }}</textarea>
                                </div>
                                @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                        ...
                        <button type="submit" class="btn btn-primary next-step">Tambah Data Principal</button>
                    </form>
                </div>
            </div>
        </div>
