    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Kelola Partner : {{ $partner->name }}</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="{{ route('partner.index') }}">Partner</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Kelola {{ $partner->name }}</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="">
        <div class="stepper">
            <div class="step active" data-step="1">
                ...
                <div class="label fs-2">Data Partner</div>
                <div class="line"></div>
            </div>
        ...
        <div id="stepper-form">
            <div class="step-content active" data-step="1">
                <div class="card" id="view-principal">
                    <div class="px-4 py-3 border-bottom w-100">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="card-title fw-semibold mb-3">Data Partner</h5>
                                    ...
                                    <div class="modal-content p-3 modal-filled bg-danger">
                                        <div class="modal-header modal-colored-header text-white">
                                            <h4 class="modal-title text-white" id="danger-header-modalLabel">
                                                Yakin ingin menghapus Partner {{$partner->name}} ?
                                            </h4>
                                            <button type="button" class="btn-close btn-close-white"
                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body" style="width: fit-content; white-space:normal">
                                            <h5 class="mt-0 text-white">Partner {{$partner->name}} akan dihapus</h5>
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-3 w-100" style="width:15em">
                            <img src="{{ $partner->image ? asset('/storage/'.$partner->image) : '/assets/images/profile/user-1.jpg' }}"
                                class="rounded-2" alt="principal Image {{ $partner->name }}" style="width: 4em" />
                ...
                <div class="row d-none" id="edit-principal">
                    <div class="col-md-4 h-100 mb-3">
                        @if($partner->image)
                        <img src="{{ '/storage/'.$partner->image }}" alt="principal Image Preview" class="rounded-4 shadow w-100"
                            style="">
                        @else
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="px-4 py-3 border-bottom">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h5 class="card-title fw-semibold mb-3">Perbarui Partner</h5>
                                    <div class="ms-auto">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="{{ route('partner.update', $partner->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Image Partner / Logo</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" value="{{ old('name', $partner->name) }}"
                                                class="form-control ps-2" placeholder="Name Partner">
                                        </div>
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text px-6" id="basic-addon1"><i
                                                    class="ti ti-text-caption fs-6"></i></span>
                                            <input type="number" name="npwp" value="{{ old('npwp', $partner->npwp) }}"
                                                class="form-control ps-2" placeholder="NPWP Partner">
                                        </div>
                                        @error('npwp')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="phone" value="{{ old('phone', $partner->phone) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text px-6" id="basic-addon1"><i
                                                            class="ti ti-phone fs-6"></i></span>
                                                    <input type="number" name="fax" value="{{ old('fax', $partner->fax) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control ps-2" name="description" id="description" cols="20" rows="5"
                                                placeholder="Description about this Partner">{{ old('description', $partner->description) }}</textarea>
                                        </div>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <select name="city" id="city_primary" class="select2-normal form-select">
                                                                ...
                                                                @foreach ($cities as $city)
                                                                    <option value="{{$city->city_name}}" {{ $city->city_name == old('city', $partner->city) || $city->city_name == old('city', strtoupper($partner->city)) ? 'selected' : '' }}>
                                                                        {{ $city->city_name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control bg-white ps-2" name="address" id="address" cols="20" rows="5"
                                                    placeholder="Alamat utama Partner">{{ old('address', $partner->address) }}</textarea>
                                            </div>
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    {{ $message }}
                                    ...
                                    <button type="submit" class="btn btn-primary next-step">Perbarui Data Partner</button>
                                </form>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="dropdown dropstart">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a href="#" class="dropdown-item text-secondary d-flex align-items-center gap-3 editAddressBtn" 
                                                    ...
                                                    data-url="{{ route('partner.address.update', ['id' => $partner->id, 'address_id' => $address->id]) }}" 
                                                ...
                                                <li>
                                                    <button type="button" class="dropdown-item d-flex align-items-center gap-3 delAddressBtn"
                                                        ...
                                                        data-id="{{$address->id}}" 
                                                        data-name="{{$address->name}}" 
                                                        data-url="{{ route('partner.address.destroy', ['id' => $partner->id, 'address_id' => $address->id]) }}" 
                                                        ><i
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('partner.address.store', $partner->id) }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text px-6" id="basic-addon1"><i
                                                    class="ti ti-map-2 fs-6"></i></span>
                                            <textarea class="form-control bg-white ps-2" name="address" id="address" cols="20" rows="5"
                                                placeholder="Alamat Pabrik / Lainnya Partner">{{ old('address') }}</textarea>
                                        </div>
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                ...
                <div id="deleteAddressModal" class="modal fade" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                        <div class="modal-content p-3 modal-filled bg-danger">
                            ...
                            <div class="modal-body" style="width: fit-content; white-space:normal">
                                <h5 class="mt-0 text-white">Alamat Partner  <span class="address_name"></span> akan dihapus</h5>
                                <p class="text-white">Segala data yang berkaitan dengan alamat tersebut juga akan dihapus secara permanen.</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-light" data-bs-dismiss="modal">
            ...
            <div class="step-content" data-step="3" style="display: none;">
                <div class="d-flex mb-3 align-items-center gap-3">
                    ...
                    <div class="d-flex align-items-center justify-content-center bg-primary text-white p-2 rounded-circle" style="aspect-ratio:1/1; width:2.5em; height:2.5em">{{ count($partner->pics) }}</div>
                    <div class="ms-auto">
                                    ...
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a href="#" class="dropdown-item text-secondary d-flex align-items-center gap-3 editPICSalesBtn" 
                                                ...
                                                data-url="{{ route('partner.pic.update', ['id' => $partner->id, 'pic_id' => $pic->id]) }}" 
                                                data-bs-toggle="modal" 
                                            ...
                                            <li>
                                                <button type="button" class="dropdown-item d-flex align-items-center gap-3 delPICSalesBtn"
                                                    ...
                                                    data-id="{{$pic->id}}" 
                                                    data-name="{{$pic->name}}" 
                                                    data-url="{{ route('partner.pic.destroy', ['id' => $partner->id, 'pic_id' => $pic->id]) }}" 
                                                    ><i
                                                        class="fs-4 ti ti-trash"></i>Delete</button>
                                            </li>
                                        </ul>
                    ...
                    <div id="deletePICSalesModal" class="modal fade" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                            <div class="modal-content p-3 modal-filled bg-danger">
                                <div class="modal-header modal-colored-header text-white">
                                    <h4 class="modal-title text-white" id="danger-header-modalLabel">
                                        Yakin ingin menghapus PIC atau Sales Partner <span class="del-pic-name"></span> ?
                                    </h4>
                                    <button type="button" class="btn-close btn-close-white"
                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body" style="width: fit-content; white-space:normal">
                                    <h5 class="mt-0 text-white">PIC atau Sales Partner <span class="del-pic-name"></span> akan dihapus</h5>
                                    <p class="text-white">Segala data yang berkaitan dengan alamat tersebut juga akan dihapus secara permanen.</p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card">
                                                ...
                                                <div class="card-body p-4">
                                                    ...
                                                    @endif
                                                    <form id="editPICSalesForm" action="{{ route('partner.pic.store', ['id' => $partner->id]) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="mb-4">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                @endif
                                <form action="{{ route('partner.pic.store', ['id' => $partner->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-4">
                                        <label class="form-label fw-semibold">Image PIC / Sales</label>
                                        <div class="input-group">
