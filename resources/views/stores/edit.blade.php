...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Edit Cabang : {{$store->name}}</h4>
    ...
    <div class="row">
        <div class="col-md-4 h-100 mb-3">
            @if($store->image)
            <img id="now-image" src="{{ '/storage/'.$store->image }}" alt="warehouse Image Preview" class="rounded-4 shadow w-100"
                style="">
            @else
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="px-4 py-3 border-bottom">
                    <h5 class="card-title fw-semibold mb-0">Edit Cabang</h5>
                </div>
                    ...
                    <form action="{{ route('store.update', $store->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="email" value="{{ old('email', $store->email) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="phone" value="{{ old('phone', $store->phone) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text px-6" id="basic-addon1"><i
                                                class="ti ti-phone fs-6"></i></span>
                                        <input type="number" name="fax" value="{{ old('fax', $store->fax) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control ps-2" name="description" id="description" cols="20" rows="5"
                                    placeholder="Description about this Cabang">{{ old('description', $store->description) }}</textarea>
                            </div>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                            ...
                                            <div style="flex-grow:1">
                                                <select name="city" id="city_added" class="select2-normal form-select">
                                                    ...
                                                    @foreach ($cities as $city)
                                                        <option value="{{$city->city_name}}" {{ $city->city_name == old('city', $store->city) ? 'selected' : '' }}>
                                                            {{ $city->city_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                            ...
                            <div class="">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control bg-white ps-2" name="address" id="address" cols="20" rows="5"
                                        placeholder="Alamat utama Cabang">{{ old('address', $store->address) }}</textarea>
                                </div>
                                @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
