                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="{{ route('purchase-order.store')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fw-semibold">Kirimkan ke Gudang</label>
                                        <div class="input-group">
                                            <span class="input-group-text px-6" id="basic-addon1"><i
                                            ...
                                            <div style="flex-grow:1">
                                                <select name="warehouse_id" id="warehouse_id" class="select2-normal form-select">
                                                    ...
                                                    @foreach ($warehouses as $warehouse)
                                                        <option value="{{$warehouse->id}}" {{$warehouse->id == old('warehouse_id', $purchase->warehouse_id) ? 'selected' : ''}}>{{$warehouse->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
            ...
            <div class="step-content" data-step="4" style="display: none;">
                ...
                @if ($purchase->generate_invoice && $purchase->invoice)
                    ...
                    <div class="card">
                        ...
                        $purchase->requestOrder && 
                        $purchase->requestOrder->invoices->where('purchase_order_id', $purchase->id)->isEmpty()
                    )
                                                            ...
                                                            @foreach ($purchase->products as $purchaseProduct)
                                                                ...
                                                                <div class="border border-1 border-dashed border-primary {{$loop->index+1 == count($purchase->products) ? '' : 'mb-2'}} p-3 rounded-3">
                                                                    ...
                                                                    <div class="d-flex align-items-end gap-2">
                                                                        <div>
                                                                            <label for="qty" class="text-muted fs-1">MemBeli Sebanyak
                                                                                (qty)</label>
                                                                            <div class="d-flex align-items-center gap-2">
                                                                                {{ $purchaseProduct->qty }}
                                                                            </div>
