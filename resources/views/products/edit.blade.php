...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4 h-100 mb-3">
            @if($product->image)
            <img id="now-image" src="{{ '/storage/'.$product->image }}" alt="Product Image Preview" class="rounded-4 shadow w-100"
                style="">
            @else
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="height" value="{{old('height', $product->height)}}" class="form-control ps-2" placeholder="Height Product">
                                    </div>
                                    @error('height')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="width" value="{{old('width', $product->width)}}" class="form-control ps-2" placeholder="Width Product">
                                    </div>
                                    @error('width')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                        ...
                        <div class="p-3 rounded-3 bg-primary-subtle mb-2">
                                ...
                                <div style="flex-grow:1">
                                    <select name="product_type_id" id="product_type_id" class="select2-normal form-select">
                                        ...
                                        @foreach ($product_types as $product_type)
                                            <option value="{{$product_type->id}}" {{ $product_type->id == old('product_type_id',$product->product_type_id) ? 'selected' : '' }}>
                                                {{ $product_type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text px-6" id="basic-addon1"><i
                                            class="ti ti-text-caption fs-6"></i></span>
                                    <input type="text" name="price_per_unit" value="{{formatRupiah(old('price_per_unit', $product->price_per_unit))}}" class="form-control bg-white ps-2 input-rupiah" placeholder="Rp. ">
                                </div>
