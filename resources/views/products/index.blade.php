                ...
                <table class="table border text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th>
                                <h6 class="fs-3 fw-semibold mb-0">Harga Per Satuan</h6>
                            </th>
                            <th>
                    ...
                    <tbody>
                        @forelse ($products as $product)
                            <tr>
                                ...
                                <td>
                                    <div class="fw-semibold">{{ formatRupiah($product->price_per_unit) }} / <span class="text-primary">{{$product->unit->code}}</span></div>
                                </td>
                                <td>
